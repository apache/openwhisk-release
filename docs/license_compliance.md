...
| Kubernetes Configurations (e.g., `*.env`) | Configuration file. Not much creativity. Example: [incubator-openwhisk//ansible/environments/distributed/files/openstack/openstack.env](https://github.com/apache/incubator-openwhisk/blob/master/ansible/environments/distributed/files/openstack/openstack.env) |
| Ansible Configuration Files (`*.cfg`, `*.ini`) | Configuration files. Not much creativity. Examples: [ incubator-openwhisk/ansible/ansible.cfg](https://github.com/apache/incubator-openwhisk/blob/master/ansible/ansible.cfg), [incubator-openwhisk/ansible/files/package-versions..ini](https://github.com/apache/incubator-openwhisk/blob/master/ansible/files/package-versions.ini) |
