...
| Docker image build file (`dockerfile`) | Mini | |
...
| # | File type | Rationale |
|:---|:---|:---|
| | Groovy scripts (`dockerhub.groovy`) | Not much creativity.</br>Example: [incubator-openwhisk/blob/master/tools/jenkins/apache/dockerhub.groovy](https://github.com/apache/incubator-openwhisk/blob/master/tools/jenkins/apache/dockerhub.groovy) |
...
| | Gradle Wrapper files (`gradlew`) | Generated by Gradle wrapper.</br>Example: [TBD]() |
| | `openwhisk/tests/dat/apigw/testswaggerdoc*` | JSON files as test input data.</br>Example: [incubator-openwhisk/blob/master/tests/dat/apigw/testswaggerdoc2](https://github.com/apache/incubator-openwhisk/blob/master/tests/dat/apigw/testswaggerdoc2) |
...
| | Ansible hosts files (`hosts`) | Not much creativity. Example: [TBD]() |
