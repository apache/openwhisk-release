...
| Ansible Configuration Files (`*.cfg`, `*.ini`) | Configuration files. Not much creativity. Examples: [.cfg](https://github.com/apache/incubator-openwhisk/blob/master/ansible/ansible.cfg), [.ini](https://github.com/apache/incubator-openwhisk/blob/master/ansible/files/package-versions.ini) |
