...
| GRDL.4 | Gradle Wrapper properties (`gradle-wrapper.properties`) | enerated by Gradle.</br>Example: [incubator-openwhisk-cli/gradle/wrapper/gradle-wrapper.properties](https://github.com/apache/incubator-openwhisk-cli/gradle/wrapper/gradle-wrapper.properties)|
| GRDL.5 | Gradle Wrapper executable JAR () | enerated by Gradle.</br>Example: [incubator-openwhisk-cli/gradle/wrapper/gradle-wrapper.jar](https://github.com/apache/incubator-openwhisk-cli/gradle/wrapper/gradle-wrapper.jar)|
